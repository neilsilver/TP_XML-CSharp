...
{
    public class VTS__iPod_MainMethods
    {
        public VTS__iPod_MainMethods(ControlSystem ControlSystem, Panel Panel)
        {
        ...
        public void Dynamic_Button_List_Vertical_SONGLIST(VTSmartObject SmartObject, SmartObjectEventArgs Args)
        {
