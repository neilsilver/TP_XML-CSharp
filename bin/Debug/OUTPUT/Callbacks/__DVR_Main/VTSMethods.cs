...
{
    public class VTS__DVR_MainMethods
    {
        public VTS__DVR_MainMethods(ControlSystem ControlSystem, Panel Panel)
        {
            ...
            this.Panel = Panel;
                ...
                public void Simple_Keypad_1(VTSmartObject SmartObject, KeypadButton Button)
        {
