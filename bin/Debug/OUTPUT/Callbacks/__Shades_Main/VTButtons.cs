...
{
    public class __Shades_MainVTButtons
    {
        public __Shades_MainVTButtons(Panel Panel)
        {
            this.Panel = Panel;
        }
/*
...
*/
        ...
        public void Button_1_1(VTButton Button, bool IsPressed)
        {
            if (IsPressed)
            {
                //press function here
        ...
        public void Button_1_2(VTButton Button, bool IsPressed)
        {
            if (IsPressed)
            {
                //press function here
        ...
        public void Button_3(VTButton Button, bool IsPressed)
        {
            if (IsPressed)
            {
                //press function here
        ...
        public void Button_4(VTButton Button, bool IsPressed)
        {
            if (IsPressed)
            {
                //press function here
        ...
        public void Button_5(VTButton Button, bool IsPressed)
        {
            if (IsPressed)
            {
                //press function here
        ...
        public void Button_6(VTButton Button, bool IsPressed)
        {
            if (IsPressed)
            {
                //press function here
